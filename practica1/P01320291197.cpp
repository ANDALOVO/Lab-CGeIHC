...
int main()
{
	...
	// RAND_MAX es el número máximo que rand() puede generar.
	// Al dividir rand() entre RAND_MAX, obtenemos un flotante entre 0.0 y 1.0.
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		if (tiempoActual - ultimoCambio >= 2.0) {
			// Generamos nuevos colores aleatorios entre 0.0 y 1.0
			color1 = (float)rand() / RAND_MAX;
			color2 = (float)rand() / RAND_MAX;
			color3 = (float)rand() / RAND_MAX;
